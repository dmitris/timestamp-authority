...
type Server struct {
	...
	SocketPath    flags.Filename `long:"socket-path" description:"the unix socket to listen on" default:"/var/run/timestamp-server.sock"`
	...
	api          *operations.TimestampServerAPI
